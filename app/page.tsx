...
const NavLink = ({
  ...
  return (
    <a
      href={href}
      className={`relative p-1 sm:p-2 rounded-full transition-colors duration-300 flex flex-col items-center ${
        active
    ...
    >
      ...
      <span className={`text-[10px] sm:text-xs mt-1 ${active ? "font-medium" : ""}`}>
        {label}
      </span>
    </a>
  );
...
export default function Home() {
  ...
  const [organizationsRef, organizationsInView] = useInView({ threshold: 0.3 });
  ...
  const [contactRef, contactInView] = useInView({
    threshold: typeof window !== "undefined" && window.innerWidth < 640 ? 0.1 : 0.5,
  });

  useEffect(() => {
    // Prioritaskan section yang lebih rendah di halaman untuk menghindari konflik
    if (contactInView) setActiveSection("contact");
    else if (certificatesInView) setActiveSection("certificates");
    else if (projectsInView) setActiveSection("projects");
    else if (skillsInView) setActiveSection("skills");
    else if (organizationsInView) setActiveSection("organizations");
  ...
  const silkColor = darkMode ? "#2C2A3B" : "#E6E6FA";
  ...
  return (
    <div className="min-h-screen transition-colors duration-300">
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-950 transition-colors duration-500">
        ...
        <nav className="fixed bottom-4 left-1/2 transform -translate-x-1/2 z-50 w-[95%] max-w-[360px] sm:max-w-md">
          <div className="flex items-center justify-between bg-white/90 dark:bg-gray-800/90 backdrop-blur-md px-1 sm:px-2 py-1 rounded-full shadow-xl border border-gray-300/50 dark:border-gray-600/50">
            <NavLink
              href="#home"
            ...
            >
              ...
              >
                <path
                  ...
                  strokeLinejoin="round"
                  strokeWidth={2}
                  d="M17 20h5v-2a2 2 0 00-2-2h-3m-2 4H7a2 2 0 01-2-2v-6a2 2 0 012-2h10a2 2 0 012 2v6a2 2 0 01-2 2zm-9-8h12M9 4a3 3 0 11-6 0 3 3 0 016 0zm12 0a3 3 0 11-6 0 3 3 0 016 0z"
                />
              </svg>
            </NavLink>
            <NavLink
            ...
            >
              <AnimatePresence mode="wait" initial={false}>
                {darkMode ? (
                  ...
                  >
                    <FaMoon className="h-4 sm:h-5 w-4 sm:w-5" />
                  </motion.span>
                ) : (
                  <motion.span
                    key="moon"
                  ...
                  >
                    <FaSun className="h-4 sm:h-5 w-4 sm:w-5" />
                  </motion.span>
                )}
              </AnimatePresence>
            </button>
  ...
  speed={5}
  scale={1}
     color={silkColor} // Warna berubah berdasarkan darkMode
  noiseIntensity={1.5}
  rotation={0}
/>
          </div>
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                  ...
                  <AnimatedFeatureCard
                    ...
                    color="bg-green-100 dark:bg-green-900/50 text-green-600 dark:text-gray-400"
                  />
        ...
        >
          <div className="container mx-auto px-6">
            <SectionHeader
              ...
              subtitle="My involvement in various organizations and communities"
            />
...
const projects: ProjectType[] = [
  {
    ...
    technologies: ["Laravel", "Tailwind", "Web Development", "UI/UX Design"],
